...
Yes/no reading-comprehension QA; exact-match scoring. Self-contained working directory for the **boolq** arm of the TokenSkip
CoT-compression study.

## Contents
- `configs/boolq_{test,train}.json` — dataset + processing config read by the engine.
- `datasets/boolq/{test,train}.jsonl` — the benchmark data.
